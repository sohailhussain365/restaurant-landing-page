...
const products = [
  {
    id: 1,
    title: "Chicken Karai",
    description: "Tender chicken cooked in our signature desi style with traditional spices. A customer favorite that brings authentic Pakistani flavors to your table.",
    price: "$14.99",
    image: "/figmaAssets/rectangle-332-3.svg",
    imageAlt: "Chicken Karai",
    badge: "Most Loved",
  },
  {
    id: 2,
    title: "Desi Murga Karai",
    description: "Whole pieces of tender chicken in a rich, aromatic karai with fresh coriander and traditional Pakistani masala. Pure desi cooking excellence.",
    price: "$15.99",
    image: "/figmaAssets/rectangle-333.svg",
    imageAlt: "Desi Murga Karai",
    badge: "",
  },
  {
    id: 3,
    title: "Chicken Tikka",
    description: "Succulent marinated chicken pieces grilled to perfection with traditional spices and served with fresh lemon. A Pakistani classic.",
    price: "$13.99",
